...
* [Casbin K8s-Gatekeeper](https://github.com/casbin/k8s-gatekeeper)
  * == Kubernetes admission webhook /
    * makes authorization -- via -- Casbin
  * steps
    * you define DECLARATIVELY models & policies / allow OR deny operations | ANY Kubernetes resource—no custom code | webhook
  * allows
    * easy to use—write ACL configurations 
      * NO need to understand Kubernetes admission webhook
    * live configuration updates -- WITHOUT -- restarting the plugin
    * FLEXIBLE apply arbitrary rules | ANY Kubernetes resource
      * -- via -- `kubectl gatekeeper`
  * maintained -- by the -- Casbin community
